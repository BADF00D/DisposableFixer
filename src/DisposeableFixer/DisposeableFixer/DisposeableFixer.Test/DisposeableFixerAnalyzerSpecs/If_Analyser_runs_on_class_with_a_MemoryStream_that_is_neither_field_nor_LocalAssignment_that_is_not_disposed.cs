...
{
    [TestFixture]
    internal class If_Analyser_runs_on_class_with_a_MemoryStream_that_is_neither_field_nor_LocalAssignment_that_is_not_disposed :
...
namespace DisFixerTest {
    class ClassWithUndisposedMemoryStreamInCtor {
        public ClassWithUndisposedMemoryStreamInCtor() {
            new MemoryStream();
        }
    }
}
