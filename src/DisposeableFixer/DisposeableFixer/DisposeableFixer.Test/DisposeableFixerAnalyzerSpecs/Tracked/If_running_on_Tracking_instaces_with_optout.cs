    ...
    internal class If_running_on_Tracking_instaces_with_optout : DisposeableFixerAnalyzerSpec
    {
		public static IEnumerable<TestCaseData> TestCases
        {
            get
            {
				...
				yield return new TestCaseData(CodeWith("new StreamWriter(new MemoryStream(), Encoding.UTF8, 1024, true)"), 1)
					.SetName("mscorelib StreamWriter leaveOpen=true");
				yield return new TestCaseData(CodeWith("new StreamReader(new MemoryStream(), Encoding.UTF8, true, 1024, true)"), 1)
				...
				yield return new TestCaseData(CodeWith("new StreamWriter(new MemoryStream(), Encoding.UTF8, 1024, false)"), 0)
					.SetName("mscorelib StreamWriter leaveOpen=false");
				yield return new TestCaseData(CodeWith("new StreamReader(new MemoryStream(), Encoding.UTF8, true, 1024, false)"), 0)
