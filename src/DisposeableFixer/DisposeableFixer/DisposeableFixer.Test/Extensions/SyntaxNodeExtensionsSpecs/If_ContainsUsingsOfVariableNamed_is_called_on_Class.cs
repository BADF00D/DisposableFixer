...
";
    ...
    [TestFixture]
    internal class If_ContainsUsingsOfVariableNamed_is_called_on_Class_with_using_statement_for_another_disposable : Spec {
        private bool _containsUsing;
        private const string Code = @"
using System.IO;
namespace DisFixerTest.Misc
...
";
    ...
    [TestFixture]
    internal class If_ContainsUsingsOfVariableNamed_is_called_on_Class_with_using_statement_for_searched_disposable : Spec {
        private bool _containsUsing;
        private const string Code = @"
using System.IO;
namespace DisFixerTest.Misc
...
";
    ...
    [TestFixture]
    internal class If_ContainsUsingsOfVariableNamed_is_called_on_Class_with_using_statement_for_searched_disposable2 : Spec {
        private bool _containsUsing;
        private const string Code = @"
using System.IO;
using System.IO;
