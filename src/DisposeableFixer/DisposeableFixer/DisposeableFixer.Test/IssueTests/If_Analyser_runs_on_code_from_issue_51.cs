...
namespace SomeNamespace
    public class SomeCode{
        ...
        public SomeCode() {
            Property = new System.IO.MemoryStream();//wrong diagnostic
        }
    }
}";
        ...
        public void Then_there_should_be_one_Diagnostics_for_Property() {
            ...
            diagnostic.Descriptor.Id.Should().Be(SyntaxNodeAnalysisContextExtension.IdForAssignmendFromObjectCreationToPropertyNotDisposed);
        }
    }
    public class SomeCode {
        public System.IDisposable Property { get; }
